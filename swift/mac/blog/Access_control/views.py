...
def adduserfield(req):
	...
	try:
            uid = Tuser.objects.get(login_name=name).tu_id
            print "------",uid
            ...
            if e[0]==1062:
                ...
                return HttpResponse(u"用户%s不存在！！！" % name)
    ...
    return render_to_response('field_classadd.html', {'af': "",'uu2': vin,'head': head,'uu4':userinfo})
